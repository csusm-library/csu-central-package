...
/* begin PRIMO Angular stuffs */
	(function() {
		...
		var app = angular.module('viewCustom', ['angularLoad', 'matomoAnalytics', 'externalSearch']);

		/**
		 * Enable Google Analytics / Piwik Analytics
		 */
		...
		angular.module('matomoAnalytics').value('analyticsOptions', {
			...
			defaultTitle: 'CSUDH University Library'
		});
